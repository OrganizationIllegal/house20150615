...
<div class="area_bkg1">当前位置:城市列表</div>
 <table id="table"
           data-url="/cityList"
            data-toggle='table'
 		data-striped='true'
        ...
        <tr>
            ...
            <th data-field="city_name" data-sortable="true">城市名称</th>
            <th data-field="pre_num" data-sortable="true">国家名称</th>
