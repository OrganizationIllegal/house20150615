...
<div style="width:168px;height:168px;border:5px solid white;float:left;"><img alt="经纪人图片" src="http://101.200.174.253:8080/all/${brokerInfo.broker_img}" style="width:168px;height:168px;"></div>
