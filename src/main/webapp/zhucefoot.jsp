...
<div class="modal fade" id="registernew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <form method="post" action="/Register" name="fmZhuCe">
  <input type="hidden" id="urlInfoReg1" name="urlInfoReg1" value="">
  <div  style="padding-top:15px;">
         <input type="text"  id="telemailnew" name="telemail" style="background-image:url(images/0.png);background-repeat:no-repeat;background-position:left;padding-left:35px;width:270px;height:34px;background-color:rgba(246, 245, 245, 1);" placeholder="手机号/邮箱" autocomplete="off">
   
   </div>
   <div>
         <input type="password" id="pwdnew" name="pwd" style="background-image:url(images/2.png);background-repeat:no-repeat;background-position:left;padding-left:35px;width:270px;height:34px;background-color:rgba(246, 245, 245, 1);" placeholder="密码" autocomplete="off">
   </div>
...
$("#register2new").click(function(){
  ...
  $("#regnew").click(function() {
	    $("#urlInfoReg1").val(href);
	    //alert($("#urlInfoReg1").val());
    	...
    	//alert(temp)             	
    	if(temp==true){	                	
            document.fmZhuCe.submit();  //fm为form表单name
    	}
    	else{               	
    		return false;
    	} 
