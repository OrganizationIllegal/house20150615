                    ...
                    <div id="panel-left" >
                      ...
                      <div class="panel-body">
                        <ul class="media-list">
                          ...
                          <c:choose>
            	<c:when test="${type==0}">
            		<img src="http://101.200.174.253:8080/all/${zhiYeDetail.image}" width="601px" height="373px">
            	</c:when>
            	<c:otherwise>
            		<img src="http://101.200.174.253:8080/all/${newsBokeDetail.news_image}" width="601px" height="373px">
            	</c:otherwise>
            </c:choose>
