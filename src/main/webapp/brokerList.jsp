...
<div class="area_bkg1">当前位置:新闻博客列表</div>
 <table id="table"
        ...
        <tr>
            ...
            <th data-field="broker_num" data-sortable="true" data-editable="true">经纪人编号</th>
            <th data-field="broker_name" data-sortable="true" data-editable="true">经纪人姓名</th>
    ...
    window.operateEvents = {
        'click .like': function (e, value, row, index) {
           // alert('You click like action, row: ' + JSON.stringify(row));
            var id=row.id;
            window.open ('/selectBroker?id='+id);
	        /*  $.ajax({
		 	    type: "POST",
