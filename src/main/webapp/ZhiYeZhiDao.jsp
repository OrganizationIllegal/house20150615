...
<html>
 ...
 <body>
   <div class="container">
    <h1> ZhiYeZhiDao <a href="https://github.com/wenzhixin/bootstrap-table-examples" class="btn btn-primary" role="button" target="_blank">Learn more &raquo;</a></h1>
    <div id="toolbar">
        <button id="remove" class="btn btn-danger" disabled>
            <i class="glyphicon glyphicon-remove"></i> Delete
        </button>
        <button id="add" class="btn btn-danger">
            <a href="AddZhiYe.jsp">insertRow</a> 
        </button>
    </div>
    <table id="table"
           ...
           data-url="/Area/listZhiye"
           data-response-handler="responseHandler">
        <thead>
        <tr>
            <th data-field="state" data-checkbox="true"></th>
            <th data-field="id" data-sortable="true">ID</th>
            <th data-field="zhiye_num" data-sortable="true" data-editable="true">zhiye_num</th>
            <th data-field="title" data-sortable="true" data-editable="true">title</th>
            <th data-field="fabu_people" data-sortable="true" data-editable="true">fabu_people</th>
            <th data-field="fabu_time" data-sortable="true" data-editable="true">fabu_time</th>
             <th data-field="fenlei" data-sortable="true" data-editable="true">fenlei</th>
             <!--<th data-field="zhiye_abstract" data-sortable="true" data-editable="true">zhiye_abstract</th>
              <th data-field="detail" data-sortable="true" data-editable="true">detail</th>-->
              <th data-field="image" data-sortable="true" data-editable="true">image</th>
...
<script>
    ...
    window.operateEvents = {
        'click .like': function (e, value, row, index) {
            var id=row.id;
            window.open ('/Area/editZhiYe?id='+id)
