...
<html>
 ...
 <body>
   <div class="container">
    <h1> PeopleInfo <a href="https://github.com/wenzhixin/bootstrap-table-examples" class="btn btn-primary" role="button" target="_blank">Learn more &raquo;</a></h1>
    <div id="toolbar">
    ...
    <table id="table"
           ...
           data-url="/Area/ListPeopleInfo"
           data-response-handler="responseHandler">
        <thead>
        <tr>
            <th data-field="state" data-checkbox="true"></th>
            <th data-field="id" data-sortable="true">ID</th>
            <th data-field="people_count" data-sortable="true" data-editable="true">people_count</th>
    ...
    window.operateEvents = {
        'click .like': function (e, value, row, index) {
            ...
            if(isNaN(id)){
            	$.ajax({
	 	    type: "POST",
	 		data: {people_count:row.people_count,area:row.area,city:row.city,project_name:row.project_name},
	 		dateType: "text json",
	 		url: "/Area/AddPeopleInfo",
	 		success:function(data){
	 			data=$.parseJSON(data);
          ...
          alert("hehe edit")
	           $.ajax({
		 	    type: "POST",
		 		data: {id: row.id,people_count:row.people_count,area:row.area,city:row.city,project_name:row.project_name},
		 		url: "/Area/UpdatePeopleInfo",
		 		success:function(data){
		 			data=$.parseJSON(data);
	 			if(data.house_pro_id==0){
	 			  alert("项目名称输入有误")
