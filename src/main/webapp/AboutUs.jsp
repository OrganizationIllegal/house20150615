   ...
   <div class="" >
		...
		<div style="width:100%;margin:0 auto;height:450px;" >
			...
			<div style="padding-top:50px;left:2%;text-align:center;color:white;font-weight:bold;-margin-top:-10px;-position:relative;-top:-501px;-left:2%;">
				...
				<!-- <img  src="../images/uswenzi.png" style="position: relative;top:-501px;left:2%">rrrr -->
				<font style="font-size:32px;font-weight:normal;color:#FFFFFF;font-family:'微软雅黑';position: relative;top:-397px;left:1%;">我们革命性的改变了</font><br><br>
				<font style="font-size:32px;font-weight:normal;color:#FFFFFF;font-family:'微软雅黑';position: relative;top:-422px;left:1%;">海外购房服务</font><br><br>
				<font style="font-size:10px;font-weight:normal;color:#FFFFFF;font-family:'微软雅黑';position: relative;top:-420px;left:1%;">海房优选通过互联网打造一个简单，透明的平台，让你聪明海外置业</font><br><br>
			</div>
			<div align=center style="position:relative; height:50px;top: -414px;/* margin: 0 auto; */left:0%;">
