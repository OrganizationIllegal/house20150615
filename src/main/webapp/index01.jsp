...
<c:forEach var="item" items="${projectList}">
  	 	<div class="col-md-4" style="padding-left:0px;">
  	     		<div><a href="/Index?proNum=${item.project_num}" target="_blank"><img alt="image" class="img-responsive"  style="width:300px;height:216px" src="<%=application.getInitParameter("imagedir")%>/${item.project_img }"></a></div>
...
<div class="row" style="text-align:center;padding-bottom:30px;height:477px">
			...
			<c:forEach var="item" items="${newsList}">
		  	 	    <div class="col-md-4" style="padding-left:0px;">
						<div ><a href="/Detail?id=${item.id}&type=1"  target="_blank"><img src="<%=application.getInitParameter("imagedir")%>/${item.news_image}" style="border:1px solid gray;width:290px;height:216px"></a></div>
