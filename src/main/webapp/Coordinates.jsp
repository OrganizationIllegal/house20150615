...
<html>
 ...
 <body>
   <div class="container">
    <h1> Coordinates <a href="https://github.com/wenzhixin/bootstrap-table-examples" class="btn btn-primary" role="button" target="_blank">Learn more &raquo;</a></h1>
    <div id="toolbar">
    ...
    <table id="table"
           ...
           data-url="/Area/ListCoordinates"
           data-response-handler="responseHandler">
        <thead>
        <tr>
            <th data-field="state" data-checkbox="true"></th>
            <th data-field="id" data-sortable="true">ID</th>
            <th data-field="longitude" data-sortable="true" data-editable="true">longitude</th>
            <th data-field="latitude" data-sortable="true" data-editable="true">latitude</th>
            <th data-field="place" data-sortable="true" data-editable="true">place</th>
    ...
    window.operateEvents = {
        'click .like': function (e, value, row, index) {
            ...
            if(isNaN(id)){
            	$.ajax({
	 	    type: "POST",
	 		data: {longitude:row.longitude,latitude:row.latitude,place:row.place,project_name:row.project_name},
	 		dateType: "text json",
	 		url: "/Area/AddCoordinates",
	 		success:function(data){
	 			data=$.parseJSON(data);
	 		...
	 		error:function(){
	           ...
	           $.ajax({
		 	    type: "POST",
		 		data: {id: row.id,longitude:row.longitude,latitude:row.latitude,place:row.place,project_name:row.project_name},
		 		url: "/Area/UpdateCoordinates",
		 		success:function(data){
		 			data=$.parseJSON(data);
	 			if(data.house_pro_id==0){
	 			  alert("项目名称输入错误")
