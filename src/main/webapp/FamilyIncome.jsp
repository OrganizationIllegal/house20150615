...
<html>
 ...
 <body>
   <div class="container">
    <h1> FamilyIncome <a href="https://github.com/wenzhixin/bootstrap-table-examples" class="btn btn-primary" role="button" target="_blank">Learn more &raquo;</a></h1>
    <div id="toolbar">
    ...
    <table id="table"
           ...
           data-url="/Area/ListFamilyIncome"
           data-response-handler="responseHandler">
        <thead>
        <tr>
            <th data-field="state" data-checkbox="true"></th>
            <th data-field="id" data-sortable="true">ID</th>
            <th data-field="family_income" data-sortable="true" data-editable="true">family_income</th>
    ...
    window.operateEvents = {
        'click .like': function (e, value, row, index) {
            ...
            if(isNaN(id)){
            	$.ajax({
	 	    type: "POST",
	 		data: {family_income:row.family_income,area:row.area,city:row.city,project_name:row.project_name},
	 		dateType: "text json",
	 		url: "/Area/AddFamilyIncome",
	 		success:function(data){
	 			data=$.parseJSON(data);
          ...
          alert("hehe edit")
	           $.ajax({
		 	    type: "POST",
		 		data: {id: row.id,family_income:row.family_income,area:row.area,city:row.city,project_name:row.project_name},
		 		url: "/Area/UpdateFamilyIncome",
		 		success:function(data){
		 			data=$.parseJSON(data);
	 			if(data.house_pro_id==0){
	 			  alert("项目名称输入有误")
