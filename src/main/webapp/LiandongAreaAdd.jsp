...
<div class="area_bkg1">当前位置:添加区域</div>
...
<span class="area_span">区域名字</span><span><input type="text" id="area_name" name="area_name" class="area_input" ></span>
</div>
<div class="area_left">
...
function addad1(){
	  ...
	  var mreco2=$("#area_name").val();
	  var mreco3=$("#center_gps").val();
	  $.ajax({
	 	    type: "POST",
	 		data: {pre_num:mreco1,area_name:mreco2,center_gps:mreco3}, 
	 		dataType: "json",
	 		url: "/SaveAddArea",
