...
<div style="font-size:12px;letter-spacing:1px;border-bottom:1px solid rgba(238, 238, 238, 1);padding:6px 0;color:rgb(137,137,137);">非常感谢浏览我们的职位空缺。如果对任何职位感兴趣，请在此</div>
<div class="" style="height:50px;padding:13px 0px;margin:0px;border-bottom:1px solid rgba(238, 238, 238, 1);font-size:15px;">
	<div class="fl w450"><div style="color:rgb(51,122,183);">市场部</div></div>
	<div class="fl w140"><div style="color:rgb(137,137,137);">市场部</div></div>
	<div class="fl w140"><div style="color:rgb(137,137,137);">销售</div></div>
	<div class="fl"><div style="color:rgb(137,137,137);text-align:right;">6.5</div></div>
</div>
<div class="" style="height:50px;padding:13px 0px;margin:0px;border-bottom:1px solid rgba(238, 238, 238, 1);font-size:15px;">
	<div class="fl w450"><div style="color:rgb(51,122,183);">市场部</div></div>
	<div class="fl w140"><div style="color:rgb(137,137,137);">市场部</div></div>
