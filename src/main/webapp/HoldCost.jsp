...
<html>
 ...
 <body>
   <div class="container">
    <h1> HoldCost <a href="https://github.com/wenzhixin/bootstrap-table-examples" class="btn btn-primary" role="button" target="_blank">Learn more &raquo;</a></h1>
    <div id="toolbar">
        ...
        $remove.click(function () {
            ...
            $.ajax({
	 		...
	 		success:function(data){
	 			alert("闁告帞濞�弫鎾诲棘閵堝棗顏堕柡鍛浮閺佹捇鏁撻敓锟�")	 			
