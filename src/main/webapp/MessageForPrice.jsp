...
<div class="area_bkg1">当前位置:索取完整价格留言列表</div>
 <!-- data-export-types:"['json', 'xml', 'txt', 'excel']" -->
 <!-- data-toggle='table' -->
 <table id="table"          

        data-toggle='table'
 		data-url="/MessagePricePageList"
 		data-striped='true'
 		data-search="true"
        ...
        <tr>
            ...
            <th data-field="viewed" data-visible="false" data-sortable="true">是否查看</th>
        </tr>
        </thead>
    </table>
</div>
