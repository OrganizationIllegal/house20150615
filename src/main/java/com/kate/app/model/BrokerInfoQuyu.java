...
public class BrokerInfoQuyu {
	...
	public BrokerInfoQuyu(){
		
	}
	public BrokerInfoQuyu(int id,String broker_name,String broker_language,String broker_region,String broker_img,String office,String introduction,String broker_num,int broker_experience,String broker_type,String broker_zizhi){
		this.id=id;
